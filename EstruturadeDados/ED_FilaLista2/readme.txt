...
3) Criar uma classe controller chamada OperacaoController, que tenha um método caixa(Fila:fila):
...
isEmpty())2.Uma determinada loja vende peças no atacado, mas, para comprar no atacado, cada cliente pode
comprar apenas um �po de peça. Criar uma aplicação java, baseada na biblioteca Fila Genérica, que faça:
1)Criar um objeto model com os atributos:
