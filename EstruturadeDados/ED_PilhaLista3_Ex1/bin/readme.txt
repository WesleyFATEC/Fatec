O algoritmo em inicializa uma pilha de inteiros e realiza operações conforme as condições:
...
c. Caso seja um número negativo, fazer o pop de 2 valores, somá-los, fazer o push do número nega�vo
